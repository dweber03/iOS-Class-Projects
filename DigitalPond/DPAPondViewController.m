...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        // cycle through 4 preset colors with swipe gesture
...
// creating swipe gesture so that we can change the background color
-(void)swipe: (UISwipeGestureRecognizer *)gesture
{
    NSLog(@"%@", gesture);
    
    // gesture recognizer right = +1 & gesture recognizer left = -1
    ...
    {
        int index = (int)[backgrounds indexOfObject:view];
